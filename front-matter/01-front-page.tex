...
\begin{titlepage}
    ...
    \ifthenelse{\equal{\SchoolOption}{uctscience}}{
        \begin{figure}
            \includegraphics[width=0.485\linewidth]{figures/theme/logotypes/uct-logo.jpg}
        \end{figure}
    }    
    ...
    % Faculty.
	{\noindent\fontsize{10}{12}\selectfont\GetFaculty}
